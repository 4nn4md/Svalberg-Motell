...
include_once($_SERVER['DOCUMENT_ROOT'] . "/innlevering8/inc/header1.php"); 
include_once($_SERVER['DOCUMENT_ROOT'] . "/innlevering8/inc/db.php"); 
include_once("inc/function.php");
print_r($_SESSION);

//$email = $_SESSION['user']['email'];
$fornavn = bigFirstLetters(getUserInfo('fornavn', $_SESSION['user']['email'], $pdo));
$etternavn = bigFirstLetters(getUserInfo('etternavn', $_SESSION['user']['email'], $pdo));
            ...
            <div class="card">
              <div class="rounded-top text-white d-flex flex-row" style="background-color: #0A3D62; height:200px;">
                <div class="ms-4 mt-5 d-flex flex-column" style="width: 150px;">
                  <img src="https://ih1.redbubble.net/image.5213265855.4264/bg,f8f8f8-flat,750x,075,f-pad,750x1000,f8f8f8.u2.jpg"
              ...
              <div class="card-body p-4 text-black mb-0">
                <div class="mb-5  text-body">
                  ...
                  <div class="p-0 bg-body-tertiary">
                    <p class="font-italic mb-0"><?php echo "E-post: " . $_SESSION['user']['email'];?></p>
                  </div>
                </div>
              </div>
            </div>

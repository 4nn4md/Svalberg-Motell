...
--
-- Host: 127.0.0.1
-- Generation Time: 28. Nov, 2024 00:09 AM
...
INSERT INTO `staff` (`staff_id`, `name`, `position`, `email`, `phone`, `hired_date`, `updated_at`, `login_attempts`, `locked_until`, `password`) VALUES
(1, 'Admin', 'Admin', 'admin@svalberg.no', '77777777', '2024-11-27 22:03:35', '2024-11-27 22:42:43', 0, NULL, '$2y$10$tVRPfzSBWGL4WLXhgIM8Ae1R5T8yFUKw7qvVyqfrsCCR3cLZUtO7S'),
(2, 'Staff', 'Staff', 'staff@svalberg.no', '12345678', '2024-11-27 22:03:35', '2024-11-27 22:03:35', 0, NULL, '$2y$10$tVRPfzSBWGL4WLXhgIM8Ae1R5T8yFUKw7qvVyqfrsCCR3cLZUtO7S');
...
INSERT INTO `users` (`user_id`, `firstName`, `lastName`, `tlf`, `username`, `password`, `role`, `login_attempts`, `locked_until`) VALUES
(1, 'test', 'one', 12345678, 'test@hotmail.com', 'test123', 'user', 0, NULL),
(2, 'bob', 'kåre', 11111111, 'ny.test@hotmail.com', 'test123', 'user', 0, NULL),
(3, 'jane', 'doe', 22222222, 'ikke_innlogget@gmail.com', 'test123', 'user', 0, NULL),
